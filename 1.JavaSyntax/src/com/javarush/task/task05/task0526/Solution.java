...
public class Solution {
    public static void main(String[] args) {
        Man man1 = new Man ("Yegor", 25, "Moscow");
        Man man2 = new Man ("Leo", 21, "Berlin");
        Woman woman1 = new Woman("Maria", 24, "Mitycshi");
        Woman woman2 = new Woman ("Liza", 23, "San-Francisco");

        System.out.println(man1.name + " " + man1.age + " " + man1.address); // можно так
        System.out.println(man2); //можно через toString
